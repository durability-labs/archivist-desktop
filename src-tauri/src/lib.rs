...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::remove_stremio_addon,
            commands::toggle_stremio_addon,
            commands::list_stremio_addons,
            commands::get_stremio_catalog,
            commands::get_stremio_meta,
            commands::get_stremio_streams,
            commands::get_stremio_subtitles,
            // IPTV commands
            commands::add_iptv_playlist,
            commands::add_iptv_playlist_content,
            commands::remove_iptv_playlist,
            commands::refresh_iptv_playlist,
            commands::list_iptv_playlists,
            commands::get_iptv_channels,
            // Debrid commands
            commands::configure_debrid,
            commands::clear_debrid,
            commands::get_debrid_status,
            commands::validate_debrid_token,
            commands::resolve_debrid_stream,
            commands::check_debrid_cache,
            // System commands
            commands::get_config,
