...
pub async fn switch_network(
    ...
    // Try to fetch marketplace contract from remote config, fall back to hardcoded
    let marketplace_contract = fetch_remote_marketplace_contract(net)
        .await
